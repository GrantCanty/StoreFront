...
function App() {
    ...
    let sds: ShopDetails = {category: "asd", gender: "asd"}

    let gg = new Map<string, Map<string, ShopDetails>>( [["testing", new Map<string, ShopDetails>([["asfasf", {category: "asd", "gender": "as"}]]) ]])
